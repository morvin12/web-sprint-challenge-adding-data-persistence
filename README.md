...
- A RDBMS is a kind of database software, specifically one which keeps the data organized into a particular kind of table. SQL is a language used to access and control RDBMSs. Pretty much all RDBMSs accept instructions in SQL, although the SQL they accept differs in small details. RDBMS is not a language but a kind of database software; SQL is not a kind of database software but a language.
...
4. What do we need in order to have a _many to many_ relationship between two tables?
   -Create a new table which will have the primary keys of both tables.
